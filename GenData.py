...
###################################################################################################
def main():
    imgTrainingNumbers = cv2.imread("numbers_test.png")            # read in training numbers image
    ...
    for npaContour in npaContours:                          # for each contour
        if cv2.contourArea(npaContour) > MIN_CONTOUR_AREA and cv2.contourArea(npaContour) < MAX_CONTOUR_AREA:          # if contour is big enough to consider
           ...
           # cv2.rectangle(imgTrainingNumbers, (intX + pointX, intY + pointY), (intX + pointX + width, intY + pointY + height),(0, 255, 0), 2)#I added this new line
